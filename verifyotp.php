...
//echo "select * from tbl_vendors where otp='$b' and id='$vendorid1'";
$sql=mysqli_query($link,"select * from tbl_vendors where   id='$vid'");
$c=mysqli_num_rows($sql);
$row=mysqli_fetch_array($sql);
$a=$row['otp'];
if($a==$b)
{
$query  = mysqli_query($link,"UPDATE tbl_vendors SET email_status  ='active' WHERE id  = '".$vid."'");	
        echo "<script>alert('please login to Continue');</script>  ";
      
       
	  echo "<script>window.location='http://www.geminimatrimony.com/login_register';</script>  ";
