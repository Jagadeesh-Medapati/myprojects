		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				...
				<div class="card card-topline-red">
					<div class="card-head">
						<header>Vendor  login details</header>
						<div class="tools">
						...
						<div class="table-wrap responsive">
							<div class="table-scrollable">
								<table class="table table-hover table-checkable order-column full-width" id="dataTables-example">
									...
									<tbody>
									<?php 
									$select_projects= mysqli_query($link,"SELECT * FROM v_login") or die(mysql_error());
									$i=1;
									while($result=  mysqli_fetch_array($select_projects)){  
									$id = $result['profile_id']; 
									$s= mysqli_query($link,"SELECT * FROM tbl_vendors where id=$id") or die(mysql_error());
									...
									?>
										<tr class="odd gradeX">
											...
											<td><?php	echo date('d/m/Y/h/i/s',strtotime($result['time']));?></td>
